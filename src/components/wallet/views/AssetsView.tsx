              ...
              tokens.map((token, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="relative w-9 h-9 rounded-full bg-[rgba(167,232,136,0.2)] flex items-center justify-center overflow-hidden">
                      {token.logoUrl ? (
                        <Image
                          src={token.logoUrl}
                          alt={token.symbol}
                        ...
                        <span className="text-sm">{token.symbol[0]}</span>
                      )}
                    </div>
                    <div>
